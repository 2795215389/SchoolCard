...
import com.js.card.api.model.GoodsExample.Criteria;
import com.js.card.api.model.GoodsExample.Criterion;
...
public class GoodsSqlProvider {
    ...
    public String insertSelective(Goods record) {
        ...
        if (record.getGoodPrice() != null) {
            sql.VALUES("GOOD_PRICE", "#{goodPrice,jdbcType=DECIMAL}");
        }
        
        if (record.getGoodStock() != null) {
            sql.VALUES("GOOD_STOCK", "#{goodStock,jdbcType=DECIMAL}");
        }
    ...
    public String selectByExample(GoodsExample example) {
        ...
        if (example != null && example.isDistinct()) {
            sql.SELECT_DISTINCT("GOOD_NO");
        } else {
            sql.SELECT("GOOD_NO");
        }
        sql.SELECT("GOOD_NAME");
        sql.SELECT("GOOD_PRICE");
        sql.SELECT("GOOD_STOCK");
        sql.FROM("GOODS");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getGoodPrice() != null) {
            sql.SET("GOOD_PRICE = #{record.goodPrice,jdbcType=DECIMAL}");
        }
        
        if (record.getGoodStock() != null) {
            sql.SET("GOOD_STOCK = #{record.goodStock,jdbcType=DECIMAL}");
        }
    ...
    public String updateByPrimaryKeySelective(Goods record) {
        ...
        if (record.getGoodPrice() != null) {
            sql.SET("GOOD_PRICE = #{goodPrice,jdbcType=DECIMAL}");
        }
        
        if (record.getGoodStock() != null) {
            sql.SET("GOOD_STOCK = #{goodStock,jdbcType=DECIMAL}");
        }
        
        sql.WHERE("GOOD_NO = #{goodNo,jdbcType=VARCHAR}");
